...
-  Скачайте приложение, укажите путь для установки `C:\Nextcloud`
...
2. Нажимаем личный кабинет
   ...
   ![](./welcome-bim-22.png){width=1447px height=398px}

3. В появившемся окне из всплывающего списка выбираем WEB Сервер Лицензий

   ![](./welcome-bim-23.png){width=888px height=673px}
...
![](./welcome-bim-22.png){width=699px height=618px}

Нажимаем проверить соединение

![](./welcome-bim-23.png){width=751px height=660px}

Далее нажимаем - «Возобновить соединение с сервером лицензий»

Все пункты должны иметь зеленый статус (если нет сообщить на почту `v.stalkovskiy@gardapro.ru`)

![](./welcome-bim-24.png){width=401px height=190px}
