...
**Скриншот 2.4. Путь пользовательских файлов**
...
**Подсказка для подготовки скриншота:** Файл -> Параметры -> Файлы. Выделить «Путь по умолчанию для пользовательских файлов» и пример отдельной папки Revit \*\_Temp.
...
**Скриншот 3.1. Открытие файла-хранилища**
...
**Подсказка для подготовки скриншота:** Диалог открытия модели. Отметить: выбранный RVT, «Создать новый локальный файл», «Задать», кнопку «Проверить» и «Открыть».

Повторяющаяся локальная копия

Если локальная копия с таким именем уже существует, исходная инструкция рекомендует выбрать вариант с добавлением штемпеля даты и времени к существующей копии.

**Скриншот 3.2. Повторяющееся имя локальной копии**
...
**Подсказка для подготовки скриншота:** Диалог Revit с двумя вариантами; выделить «Добавить штемпель даты и времени к существующей копии».
