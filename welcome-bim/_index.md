...
2 Проверить установлены необходимые версии ревита и лецензии

3 Проанализировать и установить необходимое ПО (некстклауд, яндекс мессенджер, пайревит, модплюс с заявкой на доступ) (рекомендации написать, что надо установить) + инструкция на запрос установки ПО, которого нет в «Установка ПО»
