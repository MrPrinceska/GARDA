...
[**Nextcloude**](./../BIM-instrykcii/nextcloud) - облачный сервис для хранения и работы с файлами, на нём хранится корпоративная библиотека, инструкции и записи обучений BIM-отдела

[**ModPlus**](./../BIM-instrykcii/modplus) - базовые плагины для оптимизации вашей работы в Revit
...
Для подписи на штампах необходимо [создать семейство Вашей подписи](./../BIM-instrykcii/sozdanie-semeystva-podpisi-dlya-shtampa) и добавить его в корпоративную библиотеку семейств
