...
Написать собственную инструкцию по подключению некст клауда
...
«Добрый день. При подключении к revit server появляется ошибка доступа. Прошу предоставить доступ.\]».
