...
Данный документ описывает процессы настройки и внесения данных в штампы чертежей.
...
### 2\. Параметры типа основной надписи
...
5. В параметрах типа основной надписи необходимо выбрать из выпадающего списка лого необходимой организации. Если нужного лого нет - обратиться к BIM-координатору по своему объекту (см. Рисунок 4).

   ### 3\. Параметры экземпляра основной надписи
