...
После выполнения скрипта, появляется окно с результатами обработки. В случае, если в модели по каким-то причинам есть два и более клапанов с одинаковой маркировкой, появится сообщение об ошибке.
