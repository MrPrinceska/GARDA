...
2. Нажимаем личный кабинет
   ...
   ![](./welcome-bim-22.jpeg){width=1447px height=398px}

3. В появившемся окне из всплывающего списка выбираем WEB Сервер Лицензий

   ![](./welcome-bim-23.jpeg){width=888px height=673px}
...
![](./welcome-bim.jpeg){width=699px height=618px}

Нажимаем проверить соединение

![](./welcome-bim-2.jpeg){width=751px height=660px}
...
![](./welcome-bim-24.jpeg){width=401px height=190px}