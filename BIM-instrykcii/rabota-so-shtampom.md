...
4. **Дата утверждения листа**
   ...
   -  Заполняется в параметрах экземпляра листа - параметр «Дата утверждения листа» (см. Рисунок 8).
...
1. 5 - Комплект чертежей

2. Заполняется в параметрах экземпляра листа – параметр «ADSK_Комплект чертежей» (см. Рисунок 6).
...
4. 6 - Стадия документации

5. Заполняется в параметрах экземпляра листа – параметр «G_Штамп_Стадия документации» (см. Рисунок 6).
